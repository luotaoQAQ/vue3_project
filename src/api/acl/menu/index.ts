...
export const reqAllPermission = () =>
  request.get<any, permissionResponseData>(API.GET_PERMISSION_URL)
...
// 删除菜单接口
export const reqRemovePermission = (permissionId: number) =>
  request.delete<any, any>(API.REMOVE_PERMISSION_URL + permissionId)
